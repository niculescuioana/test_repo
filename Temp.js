...
var CONFIG_URLS = {
  ...
  var masterConfigSheet = 'https://docs.google.com/spreadsheets/d/1gFB9css5eHo-OKup8jOyWQXtUNe9sgdH98bjhVnV-qQ/edit'
  var configSheet = 'Analytics';
  var LABEL = 'Yannis';
  ...
  var MASTER_EMAIL_LIST = [
    ...
    'aurelia@pushgroup.co.uk','reece@pushgroup.co.uk','mike@pushgroup.co.uk',
  ...
  function main() {
    ...
    accounts
    .withCondition('Name = "Cheaper Group"')
  ...
  function runScript(input) {
    ...
    for(var configIndex in configData) {
      ...
      if(configIndex != 6) { continue; } //Ignore first 2 rows
