...
var CONFIG_URLS = {
    'SAS': 'https://docs.google.com/spreadsheets/d/1666yj4-oXO4tOe1all9v2dWXfohLzAm7v7CUFJ84wEg/edit'
  };
  ...
  var scriptSheet = masterConfigSheet = CONFIG_URLS[LABEL]
  ...
  function main() {
    ...
    MccApp.accounts().withCondition('Name = "SAS UK"').withLimit(50).executeInParallel('runScript', 'compile', JSON.stringify(input));
  }
