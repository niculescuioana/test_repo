function main() {
    ...
    var LABEL_NAME = '';  // Input Name of Label for new accounts
    var MANAGER_EMAIL = '';  // Input main stakeholder email
    var EXEC_EMAILS = []; // Input backup stakeholders emails.
    ...
    var master_tab = SpreadsheetApp.openByUrl(MASTER_DASHBOARD).getSheetByName('Franchisee Dashboard Urls');
    ...
    var DASHBOARD_TEMPLATE = 'https://docs.google.com/spreadsheets/d/17SYDbAiw8oDOckhqV-o-Qo-C5hnDobxS-y_xD-FuRww/edit';
