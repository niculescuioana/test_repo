function main() {
  ...
  var LABEL_NAME = 'Eduard';  // Input Name of Label for new accounts
  var MANAGER_EMAIL = 'eduard@pushgroup.co.uk';  // Input main stakeholder email
  var EXEC_EMAILS = ['charlie@pushgroup.co.uk']; // Input backup stakeholders emails.
  ...
  var master_tab = SpreadsheetApp.openByUrl(MASTER_DASHBOARD).getSheetByName('Dashboard Urls');
  ...
  var DASHBOARD_TEMPLATE = 'https://docs.google.com/spreadsheets/d/1B2afK-5ViF1okJlIiZ7tr8tgEtCjDRedomzZEzCaEKY/edit';
