...
var scriptSheet = 'https://docs.google.com/spreadsheets/d/1pKtEy-MZC7Yl1XeugTXrnuRqLSnbk6scOmIOJLUNEVM/edit';
...
function main() {
  var accounts = MccApp.accounts().withIds(['919-241-6629']).executeInParallel('runScript');
}
function runScript() {
