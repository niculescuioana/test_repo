/*************************************************
* Master Reference Script - Set 1
* @author Naman Jindal <naman@pushgroup.co.uk>
* @version 1.0
***************************************************/

// Url of the Dashboard
// Pick it from Master Dashboard (Column B) -> https://docs.google.com/spreadsheets/d/16hkDsJ-K2LY0QzvcAGlsTTzGidW_Uk6C064wzY7OiF4/edit#gid=1415541725
var scriptSheet = 'https://docs.google.com/a/pushgroup.co.uk/spreadsheets/d/12weFSq0ykcTRXgIjUu_xPqwxhsyY6tX-Rc5RWqicj-w/edit';
...
var MASTER_EMAIL_LIST = [
  ...
  'jasleen@pushgroup.co.uk','tariq@pushgroup.co.uk','sunny@pushgroup.co.uk',
  'eduard@pushgroup.co.uk'
];
