...
var CONFIG_URLS = {
  'Isuru': 'https://docs.google.com/spreadsheets/d/1ldQ234BVUh2WleIVDRvsgbrJafLuP7fq7weDvKFbj0s/edit',
  'Yannis': 'https://docs.google.com/spreadsheets/d/12DkUUmJn7NQCyjypGJIby9-zc78_HYaJLu9j_TtW1QU/edit',
  'Tariq': 'https://docs.google.com/spreadsheets/d/1yL42Yrt_ms8UhzxuqUuEAjc1-_ipztGi-5xmSTD0MZw/edit#gid=1062322731',
  'Leslie': 'https://docs.google.com/spreadsheets/d/1eQZbEOuYWLcqb62NpsWDDHoQnaGb-TvRsqN3zPryDYk/edit',
  'Jay': 'https://docs.google.com/spreadsheets/d/1HSdATgm_IHStt0lwpvlxhKK1GYkv1_iq1Ys5fTxnB8I/edit#gid=0&vpid=F3',
  'Aurelia': 'https://docs.google.com/spreadsheets/d/1wdSWJFdFdlsl_Yt3jz6NbUj64tuHn2bXkGx94Gs6AkY/edit#gid=11578003',
  'Elliot': 'https://docs.google.com/spreadsheets/d/1XwEQLOWqDY8fLn45cI6Zd_uzVRdGjF82UE4x354dzL0/edit',
  'Keerat': 'https://docs.google.com/spreadsheets/d/1049doCDRjBqkP0XBCasx46Korpy1OffsGELTTy7veyE/edit#gid=0',
  'Monique': 'https://docs.google.com/spreadsheets/d/1rUi32aoDNuCwBX-ti1suIcLqL1J3vXDn1FbPCSoG1EA/edit',
  'Reece': 'https://docs.google.com/spreadsheets/d/1LpiW4pr91m9eqCguZNc7KFkRqMwTYGlpSfzryCpqf1k/edit#gid=0',
  'Ian': 'https://docs.google.com/spreadsheets/d/1TJNezTn0QIoWBCOt_iRCaxO2Yw9v9Zaffhste1klTQQ/edit#gid=0',
  'Neeraj': 'https://docs.google.com/spreadsheets/d/1WgnrCuWl6cX_8wlWAHCIF_qH1CSr1AsUcHeY5TE7p64/edit#gid=11578003',
  'Mike': 'https://docs.google.com/spreadsheets/d/1FK6RELdZd7tFmDFb8KvDEzUqg7jvlLqcB0OCR2Sf_TM/edit#gid=1836423201',
  'Sunny': 'https://docs.google.com/spreadsheets/d/1Xy4UanKOyHQodVWmpYJzIP_NiHTitUQ_sqeDV1JYOoI/edit#gid=1935271704'
};

var masterConfigSheet = 'https://docs.google.com/spreadsheets/d/1gFB9css5eHo-OKup8jOyWQXtUNe9sgdH98bjhVnV-qQ/edit#gid=1117239881'
var configSheet = 'Set 3';
var LABEL = 'Aurelia';
...
var MASTER_EMAIL_LIST = [
  ...
  'monique@pushgroup.co.uk','leslie@pushgroup.co.uk','neeraj@pushgroup.co.uk',
  'isuru@pushgroup.co.uk','jay@pushgroup.co.uk','yannis@pushgroup.co.uk',
  'aurelia@pushgroup.co.uk','reece@pushgroup.co.uk',
  'ian@pushgroup.co.uk','saqib@pushgroup.co.uk','peter@pushgroup.co.uk',
  'jasleen@pushgroup.co.uk','tariq@pushgroup.co.uk'
];
...
function runScript(input) {
  ...
  for(var configIndex in configData) {
    //if(AdWordsApp.getExecutionInfo().isPreview() && configIndex != 7) { continue; }
    if(configIndex != 8) { continue; } //Ignore first 2 rows
